...
public class PakaianViewFrame extends JFrame{
    ...
    public PakaianViewFrame(){
        ...
        ubahButton.addActionListener(e -> {
            ...
            PakaianInputFrame inputFrame = new PakaianInputFrame();
            inputFrame.setId(id);
        ...
        cariButton.addActionListener(e -> {
            ...
            String searchSQL = "SELECT*FROM pakaian WHERE merk LIKE ?";
            try {
        ...
        hapusButton.addActionListener(e -> {
            ...
            if (pilihan == 0){
                TableModel tm = viewTable.getModel();
                int id = parseInt(tm.getValueAt(barisTerpilih, 0).toString());
                Connection c = Koneksi.getConnection();
                String deleteSQL = "DELETE FROM pakaian WHERE id = ?";
                try{
        ...
        cetakButton.addActionListener(e -> {
            ...
            try {
                ...
                row = new Object[jumlah][4];
                int i = 0;
                rs.beforeFirst();
                while (rs.next()){
                    row[i][0] = rs.getInt("id");
                    row[i][1] = rs.getString("merk");
                    row[i][2] = rs.getString("warna");
            ...
            try {
                JasperReport jasperReport = JasperCompileManager.compileReport("/D:/Kuliah/Kuliah S4/PBO " +
                        "1/Tugas/Tugas_PBO1/src/main/resources/pakaian_reports.jrxml");
    ...
    public void isiTable(){
        ...
        try{
            Statement s = c.createStatement();
            ResultSet rs = s.executeQuery(selectSQL);
            String header[] = {"id", "Merk", "Warna Pakaian", "Jenis Pakaian"};
